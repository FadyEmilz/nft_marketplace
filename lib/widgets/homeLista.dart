              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return Catigories(
                        textOnImage: list_catigouries.catigories_texts[index],
                        myImage: list_catigouries.catigories_image[index],
                      );
                    },
                ...
                SizedBox(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return Collections(
                        cardName: list_collections.collection_list[index].collection_name,
                        cardImage: list_collections.collection_list[index].collection_image,
                      );
                    },
                    separatorBuilder: (context, index) {
